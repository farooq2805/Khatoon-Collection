        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-5">
              ...
              <li className="flex items-start gap-3">
                <span className="mt-0.5 flex-none">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 text-[#f57bb4]" viewBox="0 0 24 24" fill="currentColor">
                ...
                <div className="space-y-1">
                  <p className="text-[11px] uppercase tracking-widest text-white/50 font-bold">Instagram</p>
                  <a
