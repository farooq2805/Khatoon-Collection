...
export default function InstagramReels() {
  return (
    <section className="w-full bg-white py-10 md:py-16 border-t border-gray-100">
      ...
      {/* Responsive styles for the Behold widget container */}
      <style>{`
        /* Make behold-widget block-level so it respects the container width */
        behold-widget {
          display: block;
          width: 100%;
          min-height: 200px;
        ...
        /* On mobile (< 640px): constrain to 2-column look by limiting container */
      ...
      <div className="mx-auto w-full max-w-6xl px-4 md:px-8">
        ...
        {/* The widget is container-aware: narrower container = fewer columns shown */}
      ...
      {/* Behold.so widget script — exact embed code */}
      <Script
