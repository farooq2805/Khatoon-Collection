    ...
    <>
      ...
      <header className="lg:hidden sticky top-0 z-[70]">
        ...
        <div className="bg-[#FEE5ED] shadow-sm border-b border-[#f57bb4]/20">
          <div className="relative flex items-center justify-between px-3 h-[84px] bg-[#FEE5ED]">
            ...
            {/* Absolute Centered Logo Container: perfectly centered on the screen */}
            ...
            <div className="z-10 flex-shrink-0 flex justify-end gap-2.5 text-gray-800">
              <button
