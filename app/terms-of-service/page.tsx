    ...
    <div className="bg-gray-50 min-h-screen py-10 px-4">
      <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-md p-6 md:p-10">
        ...
        <p className="text-gray-600 mb-6 text-sm md:text-base">
          Welcome to <span className="font-semibold">Khatoon Collection</span>. By accessing or using
        ...
        <section className="mb-6">
          ...
          <p className="text-gray-600 text-sm md:text-base">
            ...
            property of Khatoon Collection and protected by applicable laws.
          </p>
        </section>
        ...
        <section className="mb-6">
          ...
          <p className="text-gray-600 text-sm md:text-base">
            Khatoon Collection shall not be liable for any indirect, incidental, or consequential
        ...
        <section className="mb-6">
          ...
          <div className="mt-3 text-sm md:text-base text-gray-700">
            <p>Email: <span className="font-medium">sale@khatooncollection.in</span></p>
        ...
        <div className="border-t pt-4 text-xs md:text-sm text-gray-500">
          Khatoon Collection reserves the right to update or modify these terms at any time
