...
/* ===================== MAGNIFIER IMAGE CARD ===================== */

function MagnifierImageCard({
  src,
  alt,
  index,
  onOpenZoom,
  ...
  return (
    <div
      className="relative overflow-hidden cursor-zoom-in aspect-[3/4] w-full rounded-[24px] bg-[#fafafa] border border-gray-100 shadow-sm transition-all duration-300 hover:shadow-md group"
    ...
    >
      ...
      {/* Premium hover zoom button cue */}
      <div className="absolute bottom-4 right-4 z-10 scale-90 opacity-0 transition-all duration-300 group-hover:scale-100 group-hover:opacity-100 rounded-full border border-gray-200 bg-white/95 px-4.5 py-2 text-[10px] font-bold tracking-[0.1em] shadow-md backdrop-blur">
        ZOOM
      </div>
    </div>
  );
...
<div className="lg:col-span-7">
          ...
          <div className="lg:col-span-5">
            <div className="sticky top-24">
              ...
              {/* TITLE */}
              <h1 className="text-[28px] font-semibold uppercase tracking-[0.05em] text-[#2b2b2b]">
                {title}
              </h1>
